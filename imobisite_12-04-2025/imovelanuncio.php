...
try{
  ...
  $sOpcao = array("0"=>"","L"=>"","V"=>"","LV"=>"");
  if(isset($_GET["sOpcao"]) && $_GET["sOpcao"]=="locacao"){
    $sOpcao["L"] = "selected";
  }elseif(isset($_GET["sOpcao"]) && $_GET["sOpcao"]=="venda"){
    $sOpcao["V"] = "selected";
  }else{
    $sOpcao[""] = "selected";
  }
