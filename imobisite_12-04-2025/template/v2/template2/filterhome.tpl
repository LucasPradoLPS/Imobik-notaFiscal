...
<form class="bg-white rounded shadow-sm quick-search p-20 p-xl-5 form-icon-right position-relative" name="form_imvgeral" id="form_imvgeral" method="GET">
    <h5 class="down-line mb-4">Onde você quer morar?</h5>
    <div class="row row-cols-1 g-4">
        <div class="col">
            <ul class="select-custom">
                ...
                {if $HIDDENTEMPORADA == ""}
                    <li>
                        <input type="radio" name="imoveldestinoImv" id="property-type-imoveldestino" value="1" hidden>
        ...
        <div class="col">
            <div class="position-relative">
                <button class="form-control text-start toggle-btn" data-target="#aditional-check">
                    Mais Filtros <i class="fas fa-ellipsis-v font-mini icon-font y-center text-dark"></i>
                </button>
                <!-- Advance Features -->
                <div id="aditional-check" class="aditional-features p-4" style="background-color:#f9f9f9;top:100%">
