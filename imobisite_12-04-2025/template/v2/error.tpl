...
<body class="bg-light">
<div class="position-relative rounded-2 mx-lg-10 top-50">
      ...
      <div class="container content-space-b-2" >
        <div class="text-center bg-img-start py-6">
          <div class="mb-5">
            ...
            <p class="mb-7">
              A página que você está tentando acessar <br>não foi encontrada em nosso servidor.
            </p>
            <br>
            <p class="text-primary border border-primary p-3 mb-10 rounded bg-soft-primary">
              {$ERRORMESSAGE}
            </p>
            <div class="mb-lg-0 text-center">
              <a class="btn btn-primary btn-transition" onclick="history.back()" target="_blank">Voltar ao site</a>
            </div>
          </div>
        </div>
      </div>
