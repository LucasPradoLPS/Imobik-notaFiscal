...
<div class="property-overview summary bg-white p-20 mb-30">
    <div class="row mb-4">
        <div class="col-auto">
        ...
        <div class="col-12">
            ...
            <ul class="quick-meta mt-4">
                ...
                <li class="bg-light">
                    <input type="hidden" id="url_copy_modal" value="{$URLSHARE}">                
                    ...
                    <div class="dropdown-menu border" aria-labelledby="jobOverviewShareDropdown" role="button" style="background-color:white">
                        <a class="dropdown-item dz-dropzone text-dark" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={$URLSHARE}%2F&amp;src=sdkpreparse')">
                            <i class="fa-brands fa-facebook fa-lg"></i> Facebook
                        </a>
                        <a class="dropdown-item dz-dropzone text-dark" onclick="window.open('https://api.whatsapp.com/send?text={$IMOVELSHOW->imoveltipo} {$IMOVELSHOW->imoveldestino|lower|ucwords} - {$IMOVELSHOW->bairro|lower|ucwords} | {$IMOVELSHOW->cidade|lower|ucwords} ({$IMOVELSHOW->uf}) {$URLSHARE}')">
                        ...
                        <a class="dropdown-item dz-dropzone text-dark" id="buttonShareModal" role="button" aria-expanded="false">
                ...
                <li class="bg-primary w-auto">
                    <a id="abrePropostaMobile" href="javascript:js_ImovelView({$IMOVELSHOW->idimovel},'{$nomeSeo}')" class="px-5 text-white">Veja tudo sobre este imóvel</a>
                </li>
            </ul>
            <hr>
            <div class="mt-2">
    ...
    {if $IMOVELSHOW->caracteristicas|trim != ""}    
        <div class="row row-cols-1">
            <div class="col">
                ...
                <p>{$IMOVELSHOW->caracteristicas|nl2br|truncate:600}</p>
            </div>
        </div>
    {/if}    
</div>
