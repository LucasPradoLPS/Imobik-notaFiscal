        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row row-cols-lg-4 row-cols-md-2 row-cols-2">
                    ...
                    <div class="col mb-2">
                        {if $USEMAP == true}
                            <a id="encontrarImv" class="w-100 btn btn-primary btn-transition" onclick="js_BuscaMap();" target="_blank">Buscar</a>
                        {else}
                            <a id="encontrarImv" class="w-100 btn btn-primary btn-transition" onclick="js_BuscaGridLista('{$FILEATUAL}');" target="_blank">Buscar Imóveis</a>
                        {/if}
                    </div>
                    <div class="col mb-2">
                        <div class="show-button-map">
                            <button class="w-100 btn btn-primary btn-transition" onclick="js_VerMapa()">Ver Mapa</button>
                        </div>
                    </div>                    
                </div>
                <style>
                ...
                <div id="aditional-check" class="aditional-features p-5 container w-lg-50 w-sm-100 more-filters" 
                ...
                <div class="woo-filter-bar p-3 d-flex flex-wrap justify-content-between">
                    ...
                    <div class="d-flex">
                        <span class="woocommerce-ordering-pages me-4 font-fifteen">
                                Foram encontrados 
                                <span id="mapTotalSearch"class="d-none">{$NUMREGISTROS}</span> 
                                <span id="mapItemsSearch" style="font-weight:900;font-size:16px;"><b>{$NUMREGISTROS}</b></span> 
                                registro(s)
                        </span>
