<div class="full-row p-3 mb-0 bg-light">
    <div class="container">
        <div class="row text-center">
            <div class="col">
                <h5 class="text-secondary">Imóveis relacionados com este corretor</h5>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-3">
                    ...
                    <div class="col">
                        ...
                        <div class="position-relative" id="selectBairro">
                            <select id="bairroImv" name="bairroImv" class="form-control" data-hs-tom-select-options='{literal}{"hideSearch": false}{/literal}'>
                                {if $BAIRROIMV == 0}
                                    {$selected = "selected"}
                                {else}
                                    {$selected = ""}
                    ...
                    <div class="col">
                        <br>
                        <a id="encontrarImv" class="w-100 btn btn-primary btn-transition" onclick="js_BuscaGridCorretor('{$URLSITE}','{$CODCORRETOR}','{$VIEWCORRETOR->pessoa}');" target="_blank">Encontrar Imóveis</a>                        
                    </div>
                    <div class="col">
                        <br>
                        <a class="w-100 btn btn-white btn-transition" href="javascript:js_LimpaFiltro('{$URLSITE}','{$CODCORRETOR}','{$VIEWCORRETOR->pessoa}');">Limpar Filtros</a>
                    </div>
                </div>
                <style>
                .more-filters {
