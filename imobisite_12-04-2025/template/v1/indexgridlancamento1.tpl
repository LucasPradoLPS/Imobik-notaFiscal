                        ...
                        <div class="item">           
                            <div class="property-grid-5 property-block rounded border transation-this bg-white hover-shadow">
                                <div class=" overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom">
                                    ...
                                    {/if}      
                                    <div class="item card-transition" style="min-height: 16rem; background-image: url('{$img_destaque}');background-size: cover;background-repeat: no-repeat;background-position: center center;" ></div>
                                ...
                                <div class="property_text p-3" role="button" onclick="js_ImovelView({$LANCAMENTO->idimovel},'{$nomeSeo}')">
                                    ...
                                    <div class="agent">
                                        <ul class="d-flex justify-content-between">
                                            ...
                                            <li><span>Desde</span><div class="text-dark">7/4/2021</div></li>
                                        </ul>
                                    </div>
