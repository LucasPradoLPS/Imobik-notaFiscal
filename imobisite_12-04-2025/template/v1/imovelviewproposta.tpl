  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="propostaModalLabel">Crie sua proposta customizada</h3>
      ...
      <div class="modal-body">
        ...
        <div class="mb-4 border border-1 rounded shadow-sm p-3">
          <div class="row">
            <div class="col-4">
              <a class="w-40 card card-stretched-vertical card-transition shadow-none bg-img-start" style="background-image: url({$IMGDESTAQUE1}); min-height:6rem; max-width:10rem;"></a>
            </div>
            <div class="col-6 small">
              ...
              <span class="text-body">{$IMOVELSHOW->logradouro|lower|ucwords}</span><br>
        ...
        <div class="mb-4 border border-1 rounded shadow-sm p-3 bg-light">
          <div class="row align-items-center">
            ...
            <div class="col-5 text-sm-end" style="float:right">
              ...
              <input name="formPropostaValor" type="text" class="form-control text-sm-end" id="formPropostaValor" placeholder="R$ xxxx" aria-label="" value="">
            </div>
          </div>
        </div>
        <label for="detalheImv" class="form-label text-muted">Aproveite o espaço abaixo para explicar e/ou justiticar a sua proposta</label>
        <div class="mb-4 border border-1 rounded shadow-sm p-3 bg-light">
          <div class="row align-items-center">
            <div class="col">
...
<!-- ========== SECONDARY CONTENTS ========== -->
<a style="visibility:hidden" id="idPropostaModalMsg" class="btn btn-outline-primary border-primary" href="#" data-bs-toggle="modal" data-bs-target="#propostaModalMsg">Modal</a>
