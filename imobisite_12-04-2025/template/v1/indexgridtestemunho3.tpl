    ...
    <div class="container {$HIDDENTESTEMUNHO}">
        <div class="row">
            <div class="col mb-5">
                ...
                <h2 class="down-line w-50 mx-auto mb-4 text-center w-sm-100 text-white">O que nossos clientes falam sobre nós</h2>
            </div>
        </div>
                    ...
                    <div class="text-carusel owl-carousel">
                        {foreach from=$SITE_TESTEMUNHO item="TESTEMUNHO"}                    
                            <div class="item">
                                ...
                                <blockquote class="text-white fs-5 fst-italic">“ {substr($TESTEMUNHO->depoimento, 0, 200)} ”</blockquote>
