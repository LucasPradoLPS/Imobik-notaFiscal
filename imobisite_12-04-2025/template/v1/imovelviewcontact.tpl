...
<!-- ========== SECONDARY CONTENTS ========== -->
<a style="visibility:hidden" id="idInfoImovelModal" class="btn btn-outline-primary border-primary" href="#" data-bs-toggle="modal" data-bs-target="#infoimovelModal">Modal</a>
...
<script>
  ...
  $("#div_captcha_info").load("loadcaptcha.php");
