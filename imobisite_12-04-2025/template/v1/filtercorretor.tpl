<div class="container">
  {if $IMOVELCORRETOR|count > 0}
    <div class="mb-4 text-center">
      <h3>Imóveis relacionados com este corretor</h3>
    </div>
    <!-- End Heading -->
  {/if}
  <div class="row gx-2">
    <div class="col-lg-12 col-sm-12 mb-5 mb-lg-3">
      ...
      <div class="row gx-2">
        <div class="col-lg-6 col-sm-12 mb-3">
          <select id="cidadeImv" name="cidadeImv" class="js-select form-select" onChange="js_BuscaBairroCorretor(this.value,{$CODCORRETOR})" data-hs-tom-select-options='{literal}{"hideSearch": false}{/literal}'>
            {if $CIDADEIMV == 0}
              {$selected = "selected"}
            {else}
              {$selected = ""}
      ...
      <div class="row mb-8">
        <div class="mb-lg-0 text-center">
          <a id="encontrarImv" class="btn btn-primary btn-transition" onclick="js_BuscaGridCorretor('{$URLSITE}','{$CODCORRETOR}','{$VIEWCORRETOR->pessoa}');" target="_blank">Encontrar Imóveis</a>
          <a class="btn btn-white" href="javascript:js_LimpaFiltro('{$URLSITE}','{$CODCORRETOR}','{$VIEWCORRETOR->pessoa}');">Limpar Filtros</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-1">
          <div class="row gx-3">
            <div class="col-6">
              <label for="codigoImv" class="form-label">Código do Imóvel</label>
              <input type="text" class="js-input-mask form-control" id="codigoImv" name="codigoImv" value="{$CODIGOIMV}" placeholder="Código" data-hs-mask-options='{literal}{"mask": "000000000"}{/literal}'>
            </div>
            <div class="col-6">
