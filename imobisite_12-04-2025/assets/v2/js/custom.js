    ...
    */
    ...
    if (document.querySelector('.quick-view') !== null) {
        $('.quick-view').on('click', function(e) {
            $("#modalImovelView").html('<img src="assets/v2/images/loading1.gif" style="width:100px;">');
            e.preventDefault();
            var imovel = $(this).attr('href');
            var target = "#quick-view";
            $("#modalImovelView").load("imovelviewmodal.php","imvSelect="+imovel);
