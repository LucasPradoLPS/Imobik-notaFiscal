...
class Vistoriastatus extends TRecord
{
    const TABLENAME  = 'vistoria.vistoriastatus';
    const PRIMARYKEY = 'idvistoriastatus';
    ...
    public function getVistorias()
    {
        ...
        $criteria->add(new TFilter('idvistoriastatus', '=', $this->idvistoriastatus));
    ...
    public function get_vistoria_fk_idvistoriatipo_to_string()
    {
        ...
        $values = Vistoria::where('idvistoriastatus', '=', $this->idvistoriastatus)->getIndexedArray('idvistoriatipo','{fk_idvistoriatipo->idvistoriatipo}');
    ...
    public function get_vistoria_fk_idvistoriastatus_to_string()
    {
        ...
        $values = Vistoria::where('idvistoriastatus', '=', $this->idvistoriastatus)->getIndexedArray('idvistoriastatus','{fk_idvistoriastatus->idvistoriastatus}');
        return implode(', ', $values);
    }
    ...
    public function get_vistoria_fk_idimovel_to_string()
    {
        ...
        $values = Vistoria::where('idvistoriastatus', '=', $this->idvistoriastatus)->getIndexedArray('idimovel','{fk_idimovel->idimovel}');
        return implode(', ', $values);
    }
    ...
    public function get_vistoria_fk_idcontrato_to_string()
    {
        ...
        $values = Vistoria::where('idvistoriastatus', '=', $this->idvistoriastatus)->getIndexedArray('idcontrato','{fk_idcontrato->idcontrato}');
        return implode(', ', $values);
    }
    ...
    public function get_vistoria_fk_idvistoriador_to_string()
    {
        ...
        $values = Vistoria::where('idvistoriastatus', '=', $this->idvistoriastatus)->getIndexedArray('idvistoriador','{fk_idvistoriador->pessoa}');
        return implode(', ', $values);
    }
