...
{
    const TABLENAME  = 'financeiro.banco';
    ...
    public function getPessoas()
    {
        ...
        $criteria->add(new TFilter('bancoid', '=', $this->idbanco));
    ...
    public function get_pessoa_fk_bancocontatipoid_to_string()
    {
        ...
        $values = Pessoa::where('bancoid', '=', $this->idbanco)->getIndexedArray('bancocontatipoid','{fk_bancocontatipoid->idbancotipoconta}');
    ...
    public function get_pessoa_fk_bancoid_to_string()
    {
        ...
        $values = Pessoa::where('bancoid', '=', $this->idbanco)->getIndexedArray('bancoid','{fk_bancoid->idbanco}');
        return implode(', ', $values);
    }
    ...
    public function get_pessoa_fk_bancopixtipoid_to_string()
    {
        ...
        $values = Pessoa::where('bancoid', '=', $this->idbanco)->getIndexedArray('bancopixtipoid','{fk_bancopixtipoid->idbancopixtipo}');
        return implode(', ', $values);
    }
