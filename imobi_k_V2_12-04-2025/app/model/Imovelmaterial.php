...
class Imovelmaterial extends TRecord
{
    const TABLENAME  = 'imovel.imovelmaterial';
    const PRIMARYKEY = 'idimovelmaterial';
    ...
    public function getImovels()
    {
        ...
        $criteria->add(new TFilter('idimovelmaterial', '=', $this->idimovelmaterial));
    ...
    public function get_imovel_fk_idcidade_to_string()
    {
        ...
        $values = Imovel::where('idimovelmaterial', '=', $this->idimovelmaterial)->getIndexedArray('idcidade','{fk_idcidade->idcidade}');
    ...
    public function get_imovel_fk_idlisting_to_string()
    {
        ...
        $values = Imovel::where('idimovelmaterial', '=', $this->idimovelmaterial)->getIndexedArray('idlisting','{fk_idlisting->idlisting}');
        return implode(', ', $values);
    }
    ...
    public function get_imovel_fk_idimoveldestino_to_string()
    {
        ...
        $values = Imovel::where('idimovelmaterial', '=', $this->idimovelmaterial)->getIndexedArray('idimoveldestino','{fk_idimoveldestino->idimoveldestino}');
        return implode(', ', $values);
    }
    ...
    public function get_imovel_fk_idimovelmaterial_to_string()
    {
        ...
        $values = Imovel::where('idimovelmaterial', '=', $this->idimovelmaterial)->getIndexedArray('idimovelmaterial','{fk_idimovelmaterial->idimovelmaterial}');
        return implode(', ', $values);
    }
    ...
    public function get_imovel_fk_idimovelsituacao_to_string()
    {
        ...
        $values = Imovel::where('idimovelmaterial', '=', $this->idimovelmaterial)->getIndexedArray('idimovelsituacao','{fk_idimovelsituacao->idimovelsituacao}');
        return implode(', ', $values);
    }
