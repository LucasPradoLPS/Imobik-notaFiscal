...
class Serasa extends TRecord
{
    const TABLENAME  = 'pessoa.serasa';
    const PRIMARYKEY = 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('idconsulta');
        parent::addAttribute('datecreated');
        parent::addAttribute('downloadurl');
        parent::addAttribute('createdat');
        parent::addAttribute('base64arquivo');
