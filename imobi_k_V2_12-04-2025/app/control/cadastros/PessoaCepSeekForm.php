...
class PessoaCepSeekForm extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onSelecionar = new TDataGridAction(array('PessoaCepSeekForm', 'onSelecionar'));
        ...
        $action_onSelecionar->setImage('far:hand-pointer #44bd32');
    ...
    { 
        ...
        {   
            ...
            TForm::sendData('form_PessoaForm', $send);
