...
class ExtratoImpostoDeRendaList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Extrato para Imposto de Renda");
        $this->limit = 20;
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Consultas/Relatórios","Extrato Imposto de Renda"]));
        }
