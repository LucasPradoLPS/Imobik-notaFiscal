...
class FaturaSinteticoLocadorDocument extends TPage
{
    private static $database = 'imobi_producao';
    private static $activeRecord = 'Configfull';
    private static $primaryKey = 'idconfig';
    private static $htmlFile = 'app/documents/FaturaSinteticoLocadorDocumentTemplate.html';
    ...
    public static function onGenerate($param)
    {
        try 
        {
            ...
            $criteria->setProperty('order', "dtpagamento desc");
