...
class ExtratoImobiliariaBatchDocument extends TPage
{
    ...
    private static $formName = 'form_ExtratoImobiliariaBatchDocument';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("<i class=\"fas fa-city\"></i> Extrato de Aluguéis Para Imobiliária em Lote");
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ExtratoImobiliariaBatchDocument]');
