...
class FaturaSinteticoInquilinoDocument extends TPage
{
    private static $database = 'imobi_producao';
    private static $activeRecord = 'Configfull';
    private static $primaryKey = 'idconfig';
    private static $htmlFile = 'app/documents/FaturaSinteticoInquilinoDocumentTemplate.html';
    ...
    public static function onGenerate($param)
    {
        try 
        {
            ...
            $criteria->setProperty('order', "dtvencimento asc");
            ...
            $html->setDetail('Fatura.inquilino', $objects);
            ...
            $document = 'tmp/'.uniqid().'.pdf'; 
             ...
             $object->dtatual = date("d/m/Y H:i");
             /*
             $object->cep = Uteis::mask($object->cep,'#####-###');
             $object->fone = Uteis::mask($object->fone,'(##)#### ####');
             $object->mobilephone = Uteis::mask($object->mobilephone,'(##)##### ####');
             */
