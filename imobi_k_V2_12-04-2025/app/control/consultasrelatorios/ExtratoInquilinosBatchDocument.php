...
class ExtratoInquilinosBatchDocument extends TPage
{
    ...
    private static $formName = 'form_ExtratoInquilinosBatchDocument';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("<i class=\"fas fa-user\"></i> Extrato de Aluguéis Para Inquilinos em Lote");
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ExtratoInquilinosBatchDocument]');
...
// echo '<pre>' ; print_r($object);echo '</pre>'; exit();
            ...
            $detalhes = Faturadetalhefull::getObjects($criteria_Repasse);
            ...
            $html->setDetail('Fatura.inquilino', $detalhes);
