...
class FaturaContaPagSeekWindow extends TWindow
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onSelect = new TDataGridAction(array('FaturaContaPagSeekWindow', 'onSelect'));
    ...
    { 
        ...
        {   
                if($param['key'])
                {
                    ...
                    TForm::sendData('form_FaturaContaPagForm', $send);
