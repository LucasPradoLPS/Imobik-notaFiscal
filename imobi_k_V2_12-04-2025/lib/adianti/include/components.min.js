...
f.attr("widget"))f[0].tfile.setValue(c);else if("tcombosearch"==f.attr("role")){if(f.val()!==c){var t=function(u){return/<[a-z][\s\S]*>/i.test(u.text)?$("<span>"+u.text+"</span>"):u.text};f.select2({templateResult:t,templateSelection:t}).val(c).trigger("change.select2");f.hasClass("tcombo_disabled")&&tmultisearch_disable_field(a,b)}}else if("tdbuniquesearch"==f.attr("widget")){var k=d;tdbuniquesearch_set_value(a,b,c,function(){k&&(f.attr("exitaction")&&tform_events_hang_exec(f.attr("exitaction")),
f.attr("changeaction")&&tform_events_hang_exec(f.attr("changeaction")))});d=!1}else if("multisearch"==f.attr("component"))c&&(t=function(u){return/<[a-z][\s\S]*>/i.test(u.text)?$("<span>"+u.text+"</span>"):u.text},f.select2({templateResult:t,templateSelection:t}).val(c).trigger("change.select2"));else if("radio"==f.attr("type")||"checkbox"==f.attr("type"))if(f.prop("checked",!1),c){var g=f.filter('[value="'+c+'"]').prop("checked",!0);"LABEL"==g.parent().prop("tagName")&&(g.parent().parent().find("label").removeClass("active"),
g.parent().toggleClass("active"))}else"LABEL"==f.parent().prop("tagName")&&f.parent().parent().find("label").removeClass("active");else f.val(c);d&&(f.attr("exitaction")&&tform_events_hang_exec(f.attr("exitaction")),f.attr("changeaction")&&tform_events_hang_exec(f.attr("changeaction")))}else{if(e.length){if("checkbox"==e.attr("type"))if(e.prop("checked",!1),c){e.parent().parent().find("label").removeClass("active");var l=JSON.parse(c);$.each(l,function(u,B){u=e.filter('[value="'+B+'"]').prop("checked",
!0);"LABEL"==u.parent().prop("tagName")&&u.parent().toggleClass("active")})}else e.parent().parent().find("label").removeClass("active");else if("multientry"==e.attr("component")){if(c){e.empty();var q=JSON.parse(c);$.each(q,function(u,B){e.append($("<option/>").val(B).text(B))});e.val(q).trigger("change.select2")}}else if("multisearch"==e.attr("component")&&"tuniquesearch"!==e.attr("widget")){if(c)if(q=JSON.parse(c),t=function(u){return/<[a-z][\s\S]*>/i.test(u.text)?$("<span>"+u.text+"</span>"):
u.text},"tmultisearch"==e.attr("widget"))e.select2({templateResult:t,templateSelection:t}).val(q).trigger("change.select2");else{if("tdbmultisearch"==e.attr("widget")){var v=d;tdbmultisearch_set_value(a,b,c,function(){v&&(e.attr("exitaction")&&tform_events_hang_exec(e.attr("exitaction")),e.attr("changeaction")&&tform_events_hang_exec(e.attr("changeaction")))})}else $.each(q,function(u,B){u=$($(e)[u]).attr("id");tform_send_data(a,"#"+u,B,d)});d=!1}}else if(e.length&&c)if(q=JSON.parse(c),$(e).find("option").prop("selected",
!1),"tselect"==e.attr("widget")&&1==e.length)$.each(q,function(u,B){$(e).find("option").filter('[value="'+B+'"]').prop("selected",!0)});else{var x=d;$.each(q,function(u,B){var A=$($(e)[u]).attr("id");setTimeout(function(){tform_send_data(a,"#"+A,B,x)},0,a,A,B)});d=!1}d&&(e.attr("exitaction")&&tform_events_hang_exec(e.attr("exitaction")),e.attr("changeaction")&&tform_events_hang_exec(e.attr("changeaction")))}}else tform_events_queue_push(function(){tform_send_data(a,b,c,d)})}}catch(u){console.log(u)}}
...
function ttable_add_row(a,b,c){$("#"+a+" tbody").append(base64_decode(c))}function ttable_replace_row_by_id(a,b,c){0<$("#"+a+" tbody").find("#"+b).length?$("#"+a+" tbody").find("#"+b).replaceWith(base64_decode(c)):$("#"+a+" tbody").append(base64_decode(c))};function tfieldlist_reset_fields(a,b){var c=parseInt(1E8*Math.random());$(a).attr("id",c);var d=$(a).find("input,select,textarea"),h=[];$.each(d,function(f,e){f=$(e).attr("id");var m=$(e).attr("widget"),t=$(e).attr("role");if("undefined"!==typeof f){var k=f.split("_");k.pop();var g=k.join("_"),l=g+"_"+c;k=$(e).parent();0<=h.indexOf(l)&&(l=g+parseInt(100*Math.random())+"_"+c);h.push(l);if("tdate"==m||"ttime"==m||"tdatetime"==m){$(e).attr("id",l);b&&$(e).val("");"undefined"!==typeof $(e).attr("exitaction")&&
...
b&&$(e).val(""),q=new RegExp(f,"g"),tfieldlist_execute_scripts(k,"thidden",function(u){return u=u.replace(q,l)});else if("ttext"==m)k=$(e).closest("td"),$(e).attr("id",l),b&&($(e).attr("name").match("/__row__id/")||$(e).val("")),"undefined"!==typeof $(e).attr("exitaction")&&$(e).attr("exitaction",$(e).attr("exitaction").replace(f,l)),"undefined"!==typeof $(e).attr("onblur")&&$(e).attr("onblur",$(e).attr("onblur").replace(f,l)),q=new RegExp(f,"g"),tfieldlist_execute_scripts(k,"ttext",function(u){return u=
u.replace(q,l)});else if("tdbmultisearch"==m||"tdbuniquesearch"==m)$(e).attr("id",l),$(e).removeData("select2-id").removeAttr("data-select2-id").find("option").removeAttr("data-select2-id"),$(a).removeData("select2-id").removeAttr("data-select2-id"),$(k).find(".select2-container").remove(),q=new RegExp(f,"g"),tfieldlist_execute_scripts(k,"tdbmultisearch",function(u){return u=u.replace(q,l)}),b&&setTimeout(function(){$(e).val("").trigger("change.select2")},10);else if("tmultisearch"==m||"tuniquesearch"==
m)$(e).attr("id",l),$(e).removeData("select2-id").removeAttr("data-select2-id").find("option").removeAttr("data-select2-id"),$(a).removeData("select2-id").removeAttr("data-select2-id"),$(k).find(".select2-container").remove(),q=new RegExp(f,"g"),tfieldlist_execute_scripts(k,"tmultisearch",function(u){return u=u.replace(q,l)}),b&&setTimeout(function(){$(e).val("").trigger("change.select2")},10);else if("tcombo"==m)$(e).attr("id",l),b&&$(e).val(""),"tcombosearch"==t&&($(e).removeData("select2-id").removeAttr("data-select2-id").find("optgroup").removeAttr("data-select2-id"),
$(e).removeData("select2-id").removeAttr("data-select2-id").find("option").removeAttr("data-select2-id"),$(e).removeData("select2-id").removeAttr("data-select2-id").find("optgroup").find("option").removeAttr("data-select2-id"),$(a).removeData("select2-id").removeAttr("data-select2-id"),$(k).find(".select2-container").remove()),"undefined"!==typeof $(e).attr("changeaction")&&$(e).attr("changeaction",$(e).attr("changeaction").replace(f,l)),"undefined"!==typeof $(e).attr("onchange")&&$(e).attr("onchange",
$(e).attr("onchange").replace(f,l)),q=new RegExp(f,"g"),tfieldlist_execute_scripts(k,"tcombo",function(u){return u=u.replace(q,l)});else if("tfile"==m){$(e).attr("id",l);b&&$(e).val("");k=$(e).closest("td");t=k.find(".div_file").attr("id");var v="div_file_"+l;k.find(".tfile_row_wrapper").remove();k.find(".file-response-icon").remove();k.find(".div_file").attr("id",v);$(e).css("padding-left","5px");"undefined"!==typeof $(e).attr("changeaction")&&$(e).attr("changeaction",$(e).attr("changeaction").replace(f,
l));"undefined"!==typeof $(e).attr("onchange")&&$(e).attr("onchange",$(e).attr("onchange").replace(f,l));q=new RegExp(f,"g");var x=new RegExp(t,"g");tfieldlist_execute_scripts(k,"tfile",function(u){u=u.replace(q,l);return u=u.replace(x,v)})}}"tradiobutton"==m?$(e).parent().removeClass("active"):"tcheckbutton"==m&&$(e).parent().removeClass("active")});$(a).find("[name$='__row__id[]']").val(c)}
...
function tdatagrid_update_total(a){var b=a.substring(1),c=document.querySelector(a);(new MutationObserver(function(d){d.forEach(function(h){"TBODY"==h.target.tagName&&$(a).find("[data-total-function=sum]").each(function(f,e){var m=0;f=$(e).data("column-name");var t=$(e).data("total-mask"),k=t.split(":");if(0<k.length){var g=k[0];t=k[1]}else g="",t=t.substring(1);$('[name="'+b+"_"+f+'[]"]').each(function(l,q){$(q).val()&&(m+=parseFloat($(q).val()))});$(e).html(g+" "+number_format(m,t.substring(0,1),
t.substring(1,2),t.substring(2,3)));$(e).data("value",m);$(e).attr("data-value",m)})})})).observe(c,{attributes:!0,childList:!0,characterData:!0,subtree:!0,attributeOldValue:!0,characterDataOldValue:!0})}
...
style:"display:none"});g=$("<div />",{"class":"tfile_row_1"});var v=$("<div />",{"class":"tfile_row_2"});l=$("<div />",{"class":"tfile_link_wrapper",style:"width: calc("+l+" - 25px)"});var x=$("<span />",{"class":"tfile_del_icon fa fa-minus-circle gray",title:"Remover"}),u=$("<div />",{"class":"progress-bar progress-bar-success",style:"width: 0%; height: 2px;"}),B=$("<input />",{type:"hidden",name:k.field_name,widget:"tfile"});"1"==k.image_gallery.enabled&&($(l).css("width","unset"),$(q).css("border",
"1px solid gray"),$(q).css("border-radius","3px"),$(q).css("margin","2px"));k.file_row_wrapper=q;k.file_input_hidden=B;k.file_progress_bar=u;k.file_link_wrapper=l;k.parent_container.children(".tfile_row_wrapper").remove();k.parent_container.append(q);q.append(g);q.append(v);g.append(B,l,x);v.append(u);$(x).click(function(){var A=k.getData();q.hide();k.parent_container.children("i").attr({"class":"",title:""});k.parent_container.find("[widget=tfile]").css("padding-left","5px");A.delFile=A.fileName;
...
$.inArray(g.split(".").pop().toLowerCase(),"png jpg jpeg gif svg webp ico fav".split(" "))){l='<img style="max-width:460px" src="download.php?file={file_name}">';k.popover.content&&(l=atob(k.popover.content));l=l.replace("{file_name}",g);if("1"==k.image_gallery.enabled){var v=$("<a />",{href:"download.php?file="+g,target:"_blank"}),x=$("<img />",{src:"download.php?file="+g}).height(k.image_gallery.height).width(k.image_gallery.width);v.append(x)}else v=$("<a />",{href:"download.php?file="+g,target:"_blank"});
"1"==k.popover.enabled&&v.popover({trigger:"hover",content:l,html:!0,container:"body",template:'<div class="popover" role="tooltip" style="z-index:100000;max-width:800px"><div class="arrow"></div><h3 class="popover-title popover-header"></h3><div class="popover-content popover-body"><div class="data-content"></div></div></div>',title:k.popover.title||""})}else v=$("<a />",{href:"download.php?file="+g,target:"_blank"});k.file_row_wrapper.show();"1"!=k.image_gallery.enabled&&v.append(g);q.html(v)}};
...
title:"..."})};this.onLoad=function(g){};this.onProgress=function(g){g.lengthComputable&&k.file_handling&&(g=Math.round(100*g.loaded/g.total),k.file_progress_bar.css("width",g+"%").css("height",2),k.file_link_wrapper.html(g+"%"))};this.onReadyStateChange=function(g){var l=null;try{l=g.target.status}catch(u){return}if("200"==l&&"4"==g.target.readyState&&g.target.responseText)try{var q=JSON.parse(g.target.responseText);if("success"==q.type){if(k.file_handling){var v=k.getData();v.fileName&&(v.delFile=
v.fileName);v.newFile="tmp/"+q.fileName;v.fileName="tmp/"+q.fileName;k.setData(v);k.showFile(v)}else{var x=$("#"+k.input_id).parent().children("input[type=hidden]");$(x).val(q.fileName)}k.showMessage("success",_t("success"));4==this.readyState&&"function"==typeof k.complete_action&&k.complete_action()}else k.file_handling&&k.file_row_wrapper.remove(),"function"==typeof k.error_action&&k.error_action(),k.showMessage("error",q.msg)}catch(u){"function"==typeof k.error_action&&k.error_action(),k.file_handling&&
...
{"class":"tfile_row_1"});var v=$("<div />",{"class":"tfile_row_2"});l=$("<div />",{"class":"tfile_link_wrapper",style:"width: calc("+l+" - 25px)"});var x=$("<span />",{"class":"tfile_del_icon fa fa-minus-circle gray",title:"Remover"}),u=$("<div />",{"class":"progress-bar progress-bar-success",style:"width: 0%; height: 2px;"}),B=$("<input />",{type:"hidden",name:k.field_name+"[]"});"1"==k.image_gallery.enabled&&($(l).css("width","unset"),$(q).css("border","1px solid gray"),$(q).css("border-radius",
"3px"),$(q).css("margin","2px"),$(q).css("display","inline-block"));k.file_row_wrapper=q;k.file_input_hidden=B;k.file_progress_bar=u;k.file_link_wrapper=l;k.parent_container.append(q);q.append(g);q.append(v);g.append(B,l,x);v.append(u);$(x).click(function(){var A=k.getData();q.hide();k.parent_container.children("i").attr({"class":"",title:""});k.parent_container.find("[widget=tmultifile]").css("padding-left","5px");A.delFile=A.fileName;A.delFile==A.newFile&&(A="",k.setData(A),q.remove());k.setData(A)});
...
k.popover.content&&(l=atob(k.popover.content)),l=l.replace("{file_name}",g),"1"==k.image_gallery.enabled){var v=$("<a />",{href:"download.php?file="+g,target:"_blank"}),x=$("<img />",{src:"download.php?file="+g}).height(k.image_gallery.height).width(k.image_gallery.width);v.append(x);"1"==k.popover.enabled&&q.popover({trigger:"hover",content:l,html:!0,container:"body",template:'<div class="popover" role="tooltip" style="z-index:100000;max-width:800px"><div class="arrow"></div><h3 class="popover-title popover-header"></h3><div class="popover-content popover-body"><div class="data-content"></div></div></div>',
title:k.popover.title||""})}else v=$("<a />",{href:"download.php?file="+g,target:"_blank"}),"1"==k.popover.enabled&&v.popover({trigger:"hover",content:l,html:!0,container:"body",template:'<div class="popover" role="tooltip" style="z-index:100000;max-width:800px"><div class="arrow"></div><h3 class="popover-title popover-header"></h3><div class="popover-content popover-body"><div class="data-content"></div></div></div>',title:k.popover.title||""});else v=$("<a />",{href:"download.php?file="+g,target:"_blank"});
"1"!=k.image_gallery.enabled&&v.append(g);q.html(v)}};this.getData=function(){var g=decodeURIComponent(k.file_input_hidden.val()),l="";try{l=g?JSON.parse(g):{}}catch(q){l={}}return l};this.setData=function(g){g?$(k.file_input_hidden).val(encodeURIComponent(JSON.stringify(g))):$(k.file_input_hidden).val("")};this.supportAjaxUploadWithProgress=function(){return this.supportFileAPI()&&this.supportAjaxUploadProgressEvents()&&this.supportFormData()};this.supportFileAPI=function(){var g=document.createElement("INPUT");
...
k.parent_container.children("i").attr({"class":"fa fa-spinner fa-spin fa-fw blue file-response-icon","data-original-title":"...",title:"..."})};this.onLoad=function(g){};this.onProgress=function(g){g.lengthComputable&&(g=Math.round(100*g.loaded/g.total),k.file_progress_bar.css("width",g+"%").css("height",2),k.file_link_wrapper.html(g+"%"))};this.onReadyStateChange=function(g){var l=null;try{l=g.target.status}catch(x){return}if("200"==l&&"4"==g.target.readyState&&g.target.responseText)try{var q=JSON.parse(g.target.responseText);
if("success"==q.type){if(k.file_handling){var v=k.getData();v.newFile="tmp/"+q.fileName;v.fileName="tmp/"+q.fileName;k.setData(v);k.showFile(v)}else k.file_input_hidden.val(q.fileName),k.file_link_wrapper.html(q.fileName);k.showMessage("success",_t("success"));4==this.readyState&&"function"==typeof k.complete_action&&k.complete_action()}else k.file_row_wrapper.remove(),k.showMessage("error",q.msg)}catch(x){k.file_row_wrapper.remove(),"undefined"==typeof q?k.showMessage("error",g.target.responseText):
k.showMessage("error",x)}};this.showMessage=function(g,l){k.parent_container.children("i").removeAttr("data-original-title");0<k.messages.length?("success"!=g?k.messages.push(l):k.messages.push("success"),g=0<k.messages.filter(q=>"success"==q).length?"fa fa-info-circle blue":"fa fa-exclamation-circle red",k.parent_container.find("[widget=tmultifile]").css("padding-left","20px"),k.parent_container.children("i").attr({"class":g+" file-response-icon",title:k.messages.filter(q=>"success"!=q).join(", "),
...
function tdbmultisearch_set_value(a,b,c,d){Adianti.formEventsCounter++;setTimeout(function(){var h="#"==b.substr(0,1)?$(b):$("form[name="+a+'] [name="'+b+'[]"]'),f=h.data("select2").options.options.hash;f=h.data("select2").options.options.ajax.url+"&hash="+f+"&value="+c+"&operator_idsearch=in&onlyidsearch=1&jsonvalue=1";$.ajax({url:f,dataType:"json"}).done(function(e){if(Array.isArray(e.result))if(0<e.result.length){var m=[];for(const t of e.result)e=t.split("::"),m.push(e[0]),h.find("option[value='"+
e[0]+"']").length||h.append(new Option(e[1],e[0],!0,!0));""==c||"[]"==c?h.val("").trigger("change.select2"):h.val(m).trigger("change.select2");"function"==typeof d&&d()}else h.val("").trigger("change.select2");else h.val("").trigger("change.select2");Adianti.formEventsCounter--}).fail(function(e,m,t){Adianti.formEventsCounter--;__adianti_error("Error",m+": connection failed")})},1)};function tradiogroup_enable_field(a,b){setTimeout(function(){$("form[name="+a+"] [name="+b+"]").attr("onclick",null);$("form[name="+a+"] [name="+b+"]").css("pointer-events","auto");$("form[name="+a+"] [name="+b+"]").closest(".toggle-wrapper").removeClass("tfield_block_events")},1)}
...
function tseekbutton_disable_field(a,b){try{$("form[name="+a+"] [name="+b+"]").attr("readonly",!0),$("form[name="+a+"] [name="+b+"]").addClass("tfield_disabled").removeClass("tseekentry")}catch(c){console.log(c)}setTimeout(function(){$("form[name="+a+"] [for="+b+"]").hide()},1)};function tlabel_toggle_visibility(a){$("#"+a).find("i").on("click",function(b){b=$(this).prev();"none"===b.css("filter")?(b.css("filter","blur(5px)"),$(this).switchClass("fa-eye","fa-eye-slash")):(b.css("filter",""),$(this).switchClass("fa-eye-slash","fa-eye"))})};function tselect_enable_field(a,b){form_name_sel="undefined"!=typeof a&&""!=a?'form[name="'+a+'"] ':"";var c='[name="'+b+'[]"]';-1==b.indexOf("[")&&0<$("#"+b).length&&(c="#"+b);try{"tselectsearch"==$(form_name_sel+c).attr("role")?tmultisearch_enable_field(a,b):($(form_name_sel+c).attr("onclick",null),$(form_name_sel+c).css("pointer-events","auto"),$(form_name_sel+c).removeClass("tcombo_disabled"))}catch(d){console.log(d)}}
function tselect_disable_field(a,b){form_name_sel="undefined"!=typeof a&&""!=a?'form[name="'+a+'"] ':"";var c='[name="'+b+'[]"]';-1==b.indexOf("[")&&0<$("#"+b).length&&(c="#"+b);try{"tselectsearch"==$(form_name_sel+c).attr("role")?tmultisearch_disable_field(a,b):($(form_name_sel+c).attr("onclick","return false"),$(form_name_sel+c).attr("tabindex","-1"),$(form_name_sel+c).css("pointer-events","none"),$(form_name_sel+c).addClass("tcombo_disabled"))}catch(d){console.log(d)}}
...
function tspinner_disable_field(a,b){setTimeout(function(){$("form[name="+a+"] [name="+b+"]").parent().css("pointer-events","none");$("form[name="+a+"] [name="+b+"]").addClass("tfield_disabled");$("form[name="+a+"] [name="+b+"]").attr("readonly",!0)},1)};function tfullcalendar_start(a,b,c,d,h,f,e,m,t,k,g,l,q,v,x,u){var B=0,A=0;f.failure=function(z){__adianti_failure_request(z.xhr,z.xhr.status,z.xhr.statusText)};b={headerToolbar:{left:"prev,next today",center:"title",right:"timeGridDay,timeGridWeek,dayGridMonth,listWeek"},locale:h,themeSystem:"bootstrap",hiddenDays:l,initialDate:d,initialView:c,allDaySlot:!1,datesSet:function(z,G){setTimeout(function(){__adianti_process_popover()},100)},slotMinTime:k,slotMaxTime:g,slotLabelFormat:{hour12:!1,hour:"2-digit",
minute:"2-digit"},eventTimeFormat:{hour12:!1,hour:"2-digit",minute:"2-digit"},editable:b,dayMaxEventRows:!0,events:f,eventDurationEditable:v,eventStartEditable:q,eventDisplay:"block",eventSourceSuccess:function(z){setTimeout(__adianti_process_popover,1500);return z.eventArray},eventContent:function(z){return{html:'<div class="fc-event-time">'+z.timeText+'</div><div class="fc-event-title-container"> <div class="fc-event-title fc-sticky">'+z.event.title+"</div> </div>"}},dateClick:function(z){if(""!==
e&&0==B&&0==A){var G=z.allDay?z.dateStr:moment(z.date).format("YYYY-MM-DD HH:mm:ss");__adianti_load_page(e+"&date="+G+"&view="+z.view.type)}},eventClick:function(z){""!==m&&0==B&&0==A&&__adianti_load_page(m+"&id="+z.event.id+"&key="+z.event.id+"&view="+z.view.type)},eventDragStart:function(){B=1},eventDragStop:function(){B=0},eventDrop:function(z){""!==t&&__adianti_ajax_exec(t+"&id="+z.event.id+"&key="+z.event.id+"&start_time="+moment(z.event.start).format("YYYY-MM-DD HH:mm:ss")+"&end_time="+moment(z.event.end).format("YYYY-MM-DD HH:mm:ss"))},
eventResizeStart:function(){A=1},eventResizeStop:function(){A=0},eventResize:function(z){""!==t&&__adianti_ajax_exec(t+"&id="+z.event.id+"&key="+z.event.id+"&start_time="+moment(z.event.start).format("YYYY-MM-DD HH:mm:ss")+"&end_time="+moment(z.event.end).format("YYYY-MM-DD HH:mm:ss"))}};u&&(u=($(document).innerHeight()??0)-($("html nav.navbar").innerHeight()??0)-($(".adianti_tabs_container").innerHeight()??0)-$("#adianti_div_content").innerHeight()-($("footer.main-footer").innerHeight()??0)-40,u=
Math.max(u,325),b.expandRows=!0,b.height=`${u}px`);x=Object.assign(b,JSON.parse(x));u=$("#"+a)[0];var E=new FullCalendar.Calendar(u,x);E.render();(new ResizeObserver(function(){E.render()})).observe(u);$("#"+a).data("fullcalendar",E)};function ticonview_contextmenu_start(a){$("#"+a).contextmenu(function(b){$(".dropdown-iconview").hide();var c=$("#"+a).next("ul");c.css("left",ticonview_mouseX(b,$("#"+a)));c.css("top",ticonview_mouseY(b,$("#"+a)));c.show();b.preventDefault()});return!1}function ticonview_bind_click(){$(document).bind("click",function(a){$(".dropdown-iconview").hide()})}
...
var f=h.indexOf("");-1!==f&&h.splice(f,1);f=h.join("&order[]=");__adianti_load_page(b+"&key="+c+"&id="+c+"&stage_id="+d+"&order[]="+f)}},cursor:"move",tolerance:"pointer",cancel:".kanban-item-content, .kanban-item-actions"})}
function kanban_start_load_more(a,b){$.each($("#"+a+" .kanban-stage .kanban-item-sortable"),function(c,d){var h=!0;d.onscroll=f=>{if(h){f=d.getAttribute("stage_id");var e=$(".kanban-board [stage_id="+f+"] .kanban-item").length;if(d.scrollTop+d.offsetHeight>=d.scrollHeight-20)return h=!1,__adianti_load_page(b+"&static=1&key="+f+"&offset="+e,function(){h=!0}),!1}}})}
function kanban_start_minimap(a){var b=!1;$("#"+a).closest(".kanban-board-wrapper").on("scroll",function(c){if(b)return!1;c=$(this).scrollLeft();var d=$(this).width(),h=$("#"+a).width();c=c/(h-d)*100;c*=($("#"+a+" #tkanban-layout-controller").width()-$("#"+a+" .tkanban-border-controler").width())/100;$("#"+a+" .tkanban-border-controler").css({left:c})});$("#"+a+" .tkanban-border-controler").on("mousedown",c=>{b=!0});$("#"+a+" .tkanban-border-controler").on("mouseleave",()=>{b=!1});$("#"+a+" .tkanban-border-controler").on("mouseup",
()=>{b=!1});$("#"+a+" .tkanban-border-controler").on("mousemove",c=>{b&&(c.preventDefault(),c=(document.querySelector("#"+a+" .tkanban-border-controler").offsetLeft-3)/($("#"+a+" #tkanban-layout-controller").width()-$("#"+a+" .tkanban-border-controler").width()),c=10*(document.querySelector("#"+a+" .tkanban-border-controler").offsetLeft+(-3+6*c)),$("#"+a).closest(".kanban-board-wrapper")[0].scroll({top:0,left:c,behavior:"instant"}))});$("#"+a+" .tkanban-border-controler").draggable({axis:"x",cursor:"move",
containment:"parent"});$(window).resize(function(){if(0<$("#"+a).length){let c=$("#"+a+" #tkanban-layout-controller").width()-($("#"+a+" .tkanban-border-controler").position().left+$("#"+a+" .tkanban-border-controler").width()-5);0>c&&$("#"+a+" .tkanban-border-controler").css("left",$("#"+a+" .tkanban-border-controler").position().left+c);tkanban_resize_border_controler(a)}});tkanban_resize_border_controler(a)}
...
this.remove=this.actions.find("[action=remove]");this.file.click(function(r){if(e&&!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){r.preventDefault();var p=document.createElement("div");p.id="webcam_"+t.replace(".","");p.title="WebCam";$(p).addClass("timagecropper_webcam");$("#adianti_div_content").append(p);r=.75*$(window).height();var w=r/3*4;Webcam.set({image_format:"png",width:w,height:r,dest_width:w,dest_height:r,constraints:{}});Webcam.off("error");
Webcam.on("error",function(y){"FlashError"==y.name||"WebcamError"==y.name?__adianti_error("Error",y.message):__adianti_error("Error","Could not access webcam: "+y.message)});tjquerydialog_start("#"+p.id,!0,!0,!1,w,r,0,0,2050,[{text:"Capturar",click:function(){Webcam.snap(function(y){y=x(y);var C=p.id;Webcam.reset();$("#"+C).remove();l(null,[y])})}}],function(){var y=p.id;Webcam.reset();$("#"+y).remove()},!0,"");setTimeout(function(){Webcam.attach("#"+p.id)},500)}});this.dropzone=$("#timagecropper_container_"+
...
q(r));__adianti_unblock_ui()},q=function(r){URL?(g.url=URL.createObjectURL(r),v()):FileReader&&(reader=new FileReader,reader.onload=function(p){g.url=reader.result;v()},reader.readAsDataURL(r))},v=function(){__adianti_block_ui();var r=document.createElement("div"),p=document.createElement("div"),w=document.createElement("div"),y=document.createElement("div"),C=document.createElement("img"),F=.95*$(window).width(),H=.9*$(window).height();C.src=g.url;C.id="timgagecropper_image_"+g.field;r.title=g.title;
r.id="container_timgagecropper_image_"+g.field;w.appendChild(y);p.appendChild(C);p.appendChild(w);r.appendChild(p);if(540>$(window).width())var D=F-30,I=H-200;else D=F-100,I=H-130;p.setAttribute("style","width: "+D+"px; height: "+I+"px");C.setAttribute("class","img_timagecrroper");p.setAttribute("class","container_timagecrroper");w.setAttribute("class","actions_timagecrroper");w.setAttribute("class","actions_timagecrroper");g.config.enableButtonDrag&&(p=y.appendChild,w=L(),C=M(),D=document.createElement("div"),
D.appendChild(w),D.appendChild(C),p.call(y,D));g.config.enableButtonScale&&(p=y.appendChild,w=G(),C=N(),D=document.createElement("div"),D.appendChild(w),D.appendChild(C),p.call(y,D));g.config.enableButtonZoom&&(p=y.appendChild,w=O(),C=P(),D=document.createElement("div"),D.appendChild(w),D.appendChild(C),p.call(y,D));g.config.enableButtonRotate&&(p=y.appendChild,w=Q(),C=R(),D=document.createElement("div"),D.appendChild(C),D.appendChild(w),p.call(y,D));g.config.enableButtonRotate&&y.appendChild(z());
$("#adianti_div_content").append(r);tjquerydialog_start("#"+r.id,!0,!1,!1,F,H,0,0,2050,[{text:g.buttonLabel,click:u}],null,!0,"");r=$("#timgagecropper_image_"+g.field)[0];y={viewMode:0,highlight:!0,rotatable:!0,responsive:!0,restore:!0,modal:!0,guides:!0};g.config.aspectRatio&&(y.aspectRatio=g.config.aspectRatio);g.cropper=new Cropper(r,y);__adianti_unblock_ui()},x=function(r){r=r.split(",");r=atob(r[1]);for(var p=r.length,w=new Uint8Array(p);p--;)w[p]=r.charCodeAt(p);return new File([w],g.name?g.name:
"image"+Math.floor(1E6*Math.random()+1)+".png",{type:g.type?g.type:"image/png"})},u=function(){__adianti_block_ui();var r=g.cropper.getCroppedCanvas({width:g.config.cropWidth,heigth:g.config.cropHeight}).toDataURL(g.type);$("#timagecropper_"+g.field).attr("src",r);$("#timagecropper_"+g.field).show();g.actions.show();g.placeholder.hide();if(g.base64)g.file_input_hidden.val(r);else try{var p=x(r),w=new FormData;w.append("fileName",p);var y=new XMLHttpRequest;y.open("POST",g.serviceAction,!0);y.addEventListener("readystatechange",
B,!1);y.send(w);if(g.fileHandling){var C=E();C.fileName&&C.fileName!=C.newFile&&(C.delFile=C.fileName);C.newFile="tmp/"+g.name;C.fileName="tmp/"+g.name;A(C)}else g.file_input_hidden.val(g.name)}catch(F){__adianti_error("Error",F)}$("#container_timgagecropper_image_"+g.field).closest(".ui-dialog").remove();$("#container_timgagecropper_image_"+g.field).remove();g.cropper.destroy();__adianti_unblock_ui()},B=function(r){var p=null;try{p=r.target.status}catch(y){return}if("200"==p&&"4"==r.target.readyState&&
r.target.responseText)try{var w=JSON.parse(r.target.responseText);"error"==w.type&&__adianti_error("Error",w.msg)}catch(y){__adianti_error("Error",y)}},A=function(r){r?$(g.file_input_hidden).val(encodeURIComponent(JSON.stringify(r))):$(g.file_input_hidden).val("")};g.sendData=A;var E=function(){var r=decodeURIComponent(g.file_input_hidden.val()),p="";try{p=r?JSON.parse(r):{}}catch(w){p={}}return p},z=function(){var r=document.createElement("i"),p=document.createElement("button");p.setAttribute("class",
...
function tchecklist_row_enable_check(e){$("table#"+e+" tbody tr").click((function(t){var c=$(this).find("[type=checkbox]:first");if($(t.target).is(":input")&&$(t.target).attr("id")!=c.attr("id")||$(t.target).closest(".tcheckgroup_label").length>0)return!0;t.stopImmediatePropagation(),t.stopPropagation(),t.preventDefault();var i=$(c).is(":checked");$(c).prop("checked",!i),i?$(this).removeClass("selected"):$(this).addClass("selected"),tchecklist_fire_onselect($("table#"+e))})),$("table#"+e+" tbody tr").each((function(){$(this).find("[type=checkbox]:first").click((function(t){t.stopPropagation();var c=$(this).is(":checked"),i=$(this).closest("tr");c?$(i).addClass("selected"):$(i).removeClass("selected"),tchecklist_fire_onselect($("table#"+e))}))}))}function tchecklist_fire_onselect(e){var t=e.attr("onselect");if(t){var c=e.attr("name"),i=[];e.find("tr.selected").each((function(){i.push($(this).find('input[type="checkbox"]:first'))}));var s={};s[c]=[],i.each((function(e,t){var i=$(t).attr("name");i=i.replace("check_"+c+"_",""),s[c].push(base64_decode(i))})),__adianti_post_exec(t,s,null,void 0,"1")}}function tchecklist_select_all(e,t){$("table#"+t+" tbody tr:visible").each((function(){var t=$(this),c=t.find('input[type="checkbox"]:first');!e.checked&&c.is(":checked")?($(c).prop("checked",!1),$(t).removeClass("selected")):e.checked&&!c.is(":checked")&&($(c).prop("checked",!0),$(t).addClass("selected"))})),tchecklist_fire_onselect($("table#"+t))}function tchecklist_enable_field(e){try{$('table.tchecklist[name="'+e+'"]').length>0&&$('table.tchecklist[name="'+e+'"]').parent().find(".tchecklist-disable").remove()}catch(e){console.log(e)}}function tchecklist_disable_field(e){try{$('table.tchecklist[name="'+e+'"]').length>0&&$('table.tchecklist[name="'+e+'"]').parent().prepend('<div class="tchecklist-disable"></div>')}catch(e){console.log(e)}}
function tpassword_enable_strong_validation(e,s){let i=[],a="";void 0!==s.minLength&&s.minLength.value>0&&(i.push({regex:new RegExp(`.{${s.minLength.value},}`)}),a+=`<li class='tpassword-list-item'><i class='fa fa-check'></i> <i class='fa fa-times'></i> ${s.minLength.message}</li>`),void 0!==s.requireNumbers&&s.requireNumbers.value&&(i.push({regex:/[0-9]/}),a+=`<li class='tpassword-list-item'><i class='fa fa-check'></i> <i class='fa fa-times'></i> ${s.requireNumbers.message}</li>`),void 0!==s.requireLowercase&&s.requireLowercase.value&&(i.push({regex:/[a-z]/}),a+=`<li class='tpassword-list-item'><i class='fa fa-check'></i> <i class='fa fa-times'></i> ${s.requireLowercase.message}</li>`),void 0!==s.requireUppercase&&s.requireUppercase.value&&(i.push({regex:/[A-Z]/}),a+=`<li class='tpassword-list-item'><i class='fa fa-check'></i> <i class='fa fa-times'></i> ${s.requireUppercase.message}</li>`),void 0!==s.requireSpecialChar&&s.requireSpecialChar.value&&(i.push({regex:/[^A-Za-z0-9]/}),a+=`<li class='tpassword-list-item'><i class='fa fa-check'></i> <i class='fa fa-times'></i> ${s.requireSpecialChar.message}</li>`),$(`#${e}`).attr("showpopover","true");var t=$(`#${e}`)[0];t.addEventListener("keyup",(function(){"true"==$(`#${e}`).attr("showpopover")&&($(`#${e}`).attr("showpopover","false"),$(t).popover({html:!0,placement:"top",container:"body",content:`\n              <ul class='tpassword-checklist' id='${e}-tpassword-checklist'>\n                  ${a}\n              </ul>\n              `,title:s.popoverTitle??"A senha precisa ter:"}).on("shown.bs.popover",(function(){})).on("hidden.bs.popover",(function(){$(`#${e}`).attr("showpopover","true")})).popover("show"));for(let s=0;s<i.length;s++){i[s].regex.test($(`#${e} input`).val())?($($(`#${e}-tpassword-checklist .tpassword-list-item`)[s]).find(".fa-check").show(),$($(`#${e}-tpassword-checklist .tpassword-list-item`)[s]).find(".fa-times").hide()):($($(`#${e}-tpassword-checklist .tpassword-list-item`)[s]).find(".fa-check").hide(),$($(`#${e}-tpassword-checklist .tpassword-list-item`)[s]).find(".fa-times").show())}}))}
function tfield_enable_field(e,a){try{$("form[name="+e+"] [name="+a+"]").length>0?($("form[name="+e+"] [name="+a+"]").attr("readonly",!1),$("form[name="+e+"] [name="+a+"]").removeClass("tfield_disabled").addClass("tfield")):$("#"+a).length>0&&($("#"+a).attr("readonly",!1),$("#"+a).removeClass("tfield_disabled").addClass("tfield"))}catch(e){console.log(e)}}function tfield_disable_field(e,a){try{$("form[name="+e+"] [name="+a+"]").length>0?($("form[name="+e+"] [name="+a+"]").attr("readonly",!0),$("form[name="+e+"] [name="+a+"]").removeClass("tfield").addClass("tfield_disabled")):$("#"+a).length>0&&($("#"+a).attr("readonly",!0),$("#"+a).removeClass("tfield").addClass("tfield_disabled"))}catch(e){console.log(e)}}function tfield_clear_field(e,a){try{$("form[name="+e+"] [name="+a+"]").length>0?$("form[name="+e+"] [name="+a+"]").val(""):$("#"+a).length>0&&$("#"+a).val("")}catch(e){console.log(e)}}