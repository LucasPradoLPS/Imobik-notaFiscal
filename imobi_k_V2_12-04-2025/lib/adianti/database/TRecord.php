...
abstract class TRecord implements IteratorAggregate
{
     ...
     * @return mixed False if cache is disabled, or the cache control class
     */
     ...
     * @return string|null containing the deleted at column
     */
     ...
     * @return string|null containing the created by column
     */
    ...
    /**
     * Returns the the name of the deleted by id column
     * @return A String containing the deleted by id column
     */
     ...
     * @return string|null containing the created by unit id column
     */
     ...
     * @param TRecord $object An Active Record
     * @return void
     */
     ...
     * @param array $data An indexed array containing the object properties
     * @return void
     */
     ...
     * @param array|null $filter_attributes Array of attributes to be returned
     * @return array An indexed array containing the object properties
     */
     ...
     * @return array Array of virtual data
     */
     ...
     * @param string $pattern Pattern with variables inside brackets
     * @param string|null $cast Type cast for the variables
     ...
     * @param string $pattern Pattern with variables inside brackets
     * @return float|int Result of mathematical evaluation
     */
     ...
     * @return array of persisted attributes
     */
    ...
    /**
     * Get attribute list
     * @return string comma-separated list of attributes or '*'
     */
     ...
     * @throws Exception if there's no active transaction opened
     */
     ...
     * @return TRecord The Active Record Object
     * @throws Exception if there's no active transaction opened
     */
     ...
     * @return PDOStatement|boolean Returns the result of the delete operation
     * @throws Exception if there's no active transaction opened
     */
     ...
     * @throws Exception if softdelete is not active for this entity
     */
     ...
     * @return int|null the FIRST Object ID from database
     * @throws Exception if there's no active transaction opened
     */
     ...
     * @return int|null the LAST Object ID from database
     * @throws Exception if there's no active transaction opened
     */
    ...
    /**
     * Method getObjects
     * @param TCriteria|null $criteria Optional criteria
     * @param bool $callObjectLoad If load() method from Active Records must be called to load object parts
     ...
     * @param string $composite_class Active Record Class for composite objects
     * @param string $foreign_key Foreign key in composite objects
     * @param int|null $id Primary key of parent object
     * @param string|null $order Order clause for objects
     * @return array of Active Records
     */
     ...
     * @param string $composite_class Active Record Class for composite objects
     * @param string|null $foreign_key Foreign key in composite objects
     * @param string|null $primary_key Primary key of parent object
     * @param string|null $order Order clause for objects
     * @return array of Active Records
     */
     ...
     * @param string $composite_class Active Record Class for composite objects
     * @param string $foreign_key Foreign key in composite objects
     * @param int $id Primary key of parent object
     * @param bool $callObjectLoad Whether to call load() method from Active Records
     */
     ...
     * @param string $foreign_key Foreign key in composite objects
     * @param int $id Primary key of parent object
     * @param array $objects Array of Active Records to be saved
     * @param bool $callObjectLoad Whether to call load() method from Active Records
     */
     ...
     * @param string $aggregate_class Active Record Class for aggregated objects
     * @param string $join_class Active Record Join Class (Parent / Aggregated)
     * @param string $foreign_key_parent Foreign key in Join Class to parent object
     * @param string $foreign_key_child Foreign key in Join Class to child object
     * @param int|null $id Primary key of parent object
     * @return array of Active Records
     */
     ...
     * @param string $aggregate_class Active Record Class for aggregated objects
     * @param string|null $join_class Active Record Join Class (Parent / Aggregated)
     * @param string|null $foreign_key_parent Foreign key in Join Class to parent object
     * @param string|null $foreign_key_child Foreign key in Join Class to child object
     * @return array of Active Records
     */
     ...
     * @param bool $withTrashed Whether to include soft-deleted records
     * @return TRecord|null the first object found or null if none found
     */
     ...
     * @param array|null $filters Optional filters for finding the record
     * @return TRecord a found record or a new instance
     */
     ...
     * @param array|null $filters Optional filters for finding the record
     * @return TRecord a found record or a new stored instance
     */
     ...
     * @param bool $withTrashed Whether to include soft-deleted records
     * @return TRecord|null the last object found or null if none found
     */
    ...
    /**
     * Returns all objects
     * @param bool $indexed Whether to index the resulting array by primary key
     * @param bool $withTrashed Whether to include soft-deleted records
     * @return array all records as an array
     */
    ...
    /**
     * Save the object
     * @return TRecord the current object
     */
     ...
     * @param string $indexColumn Column for key values
     * @param string $valueColumn Column for values
     * @param TCriteria|null $criteria Optional criteria
     * @param bool $withTrashed Whether to include soft-deleted records
     * @return array indexed array where the index is $indexColumn and the value is $valueColumn
     */
     ...
     * @return TRepository the TRepository object with a filter
     */
     ...
     * @return TRepository the TRepository object with a group
     */
    ...
    /**
     * Creates a Repository with filter
     * @param string $variable Variable to be filtered
     * @param string $operator Operator (>, <, =, !=, <=, >=, IN, NOT IN, LIKE, IS NULL, IS NOT NULL)
     * @param mixed $value Value to be filtered
     * @param string $logicOperator Logic operator (TExpression::AND_OPERATOR, TExpression::OR_OPERATOR)
     * @return TRepository the TRepository object with a filter
     */
     ...
     * @param string $operator Operator (>, <, =, !=, <=, >=, IN, NOT IN, LIKE, IS NULL, IS NOT NULL)
     * @param mixed $value Value to be filtered
     * @return TRepository the TRepository object with an OR filter
     */
     ...
     * @return TRepository the TRepository object
     */
    ...
    /**
     * Include trashed objects in the query
     * @return TRepository the TRepository object
     */
